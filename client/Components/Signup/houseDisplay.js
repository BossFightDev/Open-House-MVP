          ...
          <TouchableOpacity style={this.props.styles.card}>
            ...
            <View style={this.props.styles.realtorDetailsContainer}>
              <View style={this.props.styles.realtorDetails}>
                <Image source={{uri: this.props.user.companyPicture}} style={this.props.styles.realtorImage}
                resizeMode='contain'
                />
                <View style={this.props.styles.realtorInfoContainer}>
                  <View style={this.props.styles.realtorInfo}>
                    <CustomText font='bold' style={this.props.styles.realtorName}>{`${this.props.user.firstName} ${this.props.user.lastName}`}</CustomText>
                    <CustomText style={this.props.styles.realtorText}>, REALTOR</CustomText>
                  </View>
                  <CustomText style={this.props.styles.company}>{this.props.user.company}</CustomText>
                  <View style={this.props.styles.contactInfo}>
                    <CustomText style={this.props.styles.phoneNumber}>{this.props.user.phoneNumber}</CustomText>
                    <CustomText style={this.props.styles.email}>{this.props.user.email}</CustomText>
                  </View>
                </View>
              </View>
            </View>
